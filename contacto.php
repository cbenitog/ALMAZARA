...
HABITACI�N: " . $habitacion->datos["nombre"] . "<br/>
...
ESTE CORREO NO CONSTITUYE UNA CONFIRMACI�N DE LA RESERVA.  EL HOTEL SE PONDR� EN CONTACTO CON USTEDES PARA CONFIRMAR DISPONIBILIDAD Y FORMALIZAR LA MISMA"; 
				$salida = $mail->enviar();
				...
				if ($mail->error) {
					...
					Ha habido un error en el env�o. Puede ponerse en contacto con nosotros a trav�s del email info@almazaradevaldeverdeja.com
			</div>
								</div>
					";
