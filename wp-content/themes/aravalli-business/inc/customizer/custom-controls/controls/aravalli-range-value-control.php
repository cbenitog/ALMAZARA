 ...
 * @access public
 */
class Aravalli_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Aravalli_Customizer_Range_Control constructor.
	 *
 ...
 */
function aravalli_sanitize_range_value( $input ) {
	if ( aravalli_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function aravalli_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
