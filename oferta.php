		...
		if ($_REQUEST["grabar"]) {
			...
			if ($post->error) {
				...
				if (!$this->id) {
					...
					loggear("oferta - edici�n - $this->id - " . $this->datos["titulo"]);
				}
			...
			$o .= "
				<div class='tabla_tr'>
				 ...
				 <div class='tabla_td' style='width: 73%;'>
					...
					<span class='a' onclick=\"modulo(['oferta','detalle_editar','&id_oferta=$this->id','detalle_editar',0,0]);\">a�adir detalle</span>
				...
				<div class='tabla_tr'>
				 ...
				 <div class='tabla_td' style='width: 73%;'>
					...
					<span class='a' onclick=\"modulo(['oferta','caracteristica_editar','&id_oferta=$this->id','caracteristica_editar',0,0]);\">a�adir caracter�stica</span>
